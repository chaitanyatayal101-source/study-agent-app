  ...
  return (
    <section className="rounded-2xl border border-slate-800 bg-red-900/80 p-4 shadow-lg shadow-slate-950/40 sm:p-6">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="/" className="inline-flex items-center justify-center rounded-full border border-slate-700 px-4 py-2 text-sm text-slate-200 transition hover:border-blue-500 hover:text-white">
          Back to chat
        </a>
      </div>
